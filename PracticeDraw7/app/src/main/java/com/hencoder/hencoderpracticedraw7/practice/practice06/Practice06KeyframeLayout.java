    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe start = Keyframe.ofFloat(0, 0f);
                Keyframe key = Keyframe.ofFloat(0.5f, 100f);
                Keyframe end = Keyframe.ofFloat(1, 80f);

                PropertyValuesHolder holder = PropertyValuesHolder.ofKeyframe("progress", start, key, end);
