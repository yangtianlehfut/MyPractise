...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        BitmapShader batman = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        BitmapShader logo = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        ComposeShader composeShader = new ComposeShader(batman, logo, PorterDuff.Mode.DST_IN);
