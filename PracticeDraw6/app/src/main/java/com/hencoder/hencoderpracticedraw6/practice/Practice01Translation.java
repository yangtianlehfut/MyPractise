    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (clickCount % 6){
                    case 0:
                        imageView.animate().translationX(300).setDuration(800).start();
                        break;
                    case 1:
                        imageView.animate().translationX(0).setDuration(800).start();
                        break;
                    case 2:
                        imageView.animate().translationY(100).setDuration(800).start();
                        break;
                    case 3:
                        imageView.animate().translationY(0).setDuration(800).start();
                        break;
                    case 4:
                        imageView.animate().translationZ(100).setDuration(800).start();
                        break;
                    case 5:
                        imageView.animate().translationZ(0).setDuration(800).start();
                        break;
                }
                clickCount ++;
            }
