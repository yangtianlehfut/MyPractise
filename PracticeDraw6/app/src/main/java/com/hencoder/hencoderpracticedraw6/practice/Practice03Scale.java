    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (clickCount % 4){
                    case 0:
                        imageView.animate().scaleX(1.2f).setDuration(800).start();
                        break;
                    case 1:
                        imageView.animate().scaleX(1.0f).setDuration(800).start();
                        break;
                    case 2:
                        imageView.animate().scaleY(0.8f).setDuration(800).start();
                        break;
                    case 3:
                        imageView.animate().scaleY(1.0f).setDuration(800).start();
                        break;
                }
                clickCount ++;
            }
